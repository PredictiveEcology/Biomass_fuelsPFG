...
test_dir("E:/GitHub/LandscapesInMotion/R/SpaDES/m/Biomass_fuelsPFG/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("E:/GitHub/LandscapesInMotion/R/SpaDES/m/Biomass_fuelsPFG/tests/testthat/test-template.R")
